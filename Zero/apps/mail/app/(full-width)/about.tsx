...
const sections = [
  {
    ...
    content: (
      <p>
        Solmail is an AI-powered email client that manages your inbox, so you don't have to. We help
  ...
  },
  {
    ...
    content: (
      <p>
        We started Solmail because we were frustrated that email — the most-used communication tool in
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          Solmail is built on the principles of transparency and community collaboration. Our entire
        ...
        <ul className="ml-4 list-disc space-y-2">
          ...
          <li>Self-host their own instance of Solmail</li>
        ...
        <p>
          ...
          source, we ensure that Solmail remains transparent, trustworthy, and accessible to everyone.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-4">
        ...
        <p>
          ...
          it manually. Solmail is poised to fundamentally change the way the world deals with
